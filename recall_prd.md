...
### ❌ TODO — Essential for v1.0
| Feature | Priority | Why |
|---------|----------|-----|
| **Seed/demo data** | 🔴 HIGH | Must work on first open with zero setup |
| **Onboarding flow** | 🔴 HIGH | Welcome screen → guided first experience |
...
| **Add card from anywhere** | 🟡 MEDIUM | Global shortcut (Ctrl+N) to quick-add a card |
| **README rewrite** | 🔴 HIGH | Reflect actual features, screenshots, philosophy |
| **CONTRIBUTING.md** | 🟢 LOW | Open-source readiness |
| **QA checklist update** | 🟢 LOW | Match current feature set |

### 🌙 Post-v1.0 Ideas
- Spaced repetition calendar view
- Study reminders (optional, local)
- Card templates (basic, cloze, etc.)
